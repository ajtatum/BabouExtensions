...
namespace BabouExtensions
{
    ...
    public static class StringSafe
    {
        ...
        public static T ToEnumOrDefault<T>(this string source, T defaultVal, bool ignoreCase = true)
            where T : struct
        {
            return source.TryToEnum(out T value, ignoreCase) ? value : defaultVal;
        }
        ...
        /// <typeparam name="T">Enum type</typeparam>
        /// <exception cref="ArgumentException"></exception>
        public static T ToEnumUncheckedOrDefault<T>(this string source, T defaultVal, bool ignoreCase = true)
            where T : struct
        {
            return source.TryToEnumUnchecked(out T value, ignoreCase) ? value : defaultVal;
        }
        ...
        public static bool ToOrDefault(this string source, bool defaultVal)
        {
            return source.TryTo(out bool value) ? value : defaultVal;
        }
        ...
        public static int ToOrDefault(this string source, int defaultVal, NumberStyles style = NumberStyles.Any,
            IFormatProvider formatProvider = null)
        {
            return source.TryTo(out int value, style, formatProvider) ? value : defaultVal;
        }
        ...
        /// <param name="style">Style to use during parsing</param>
        /// <param name="formatProvider">Format provider</param>
        public static long ToOrDefault(this string source, long defaultVal, NumberStyles style = NumberStyles.Any,
            IFormatProvider formatProvider = null)
        {
            return source.TryTo(out long value, style, formatProvider) ? value : defaultVal;
        }
        ...
        /// <param name="style">Style to use during parsing</param>
        /// <param name="formatProvider">Format provider</param>
        public static byte ToOrDefault(this string source, byte defaultVal, NumberStyles style = NumberStyles.Any,
            IFormatProvider formatProvider = null)
        {
            return source.TryTo(out byte value, style, formatProvider) ? value : defaultVal;
        }
        ...
        /// <param name="style">Style to use during parsing</param>
        /// <param name="formatProvider">Format provider</param>
        public static sbyte ToOrDefault(this string source, sbyte defaultVal, NumberStyles style = NumberStyles.Any,
            IFormatProvider formatProvider = null)
        {
            return source.TryTo(out sbyte value, style, formatProvider) ? value : defaultVal;
        }
        ...
        /// <param name="style">Style to use during parsing</param>
        /// <param name="formatProvider">Format provider</param>
        public static short ToOrDefault(this string source, short defaultVal, NumberStyles style = NumberStyles.Any,
            IFormatProvider formatProvider = null)
        {
            return source.TryTo(out short value, style, formatProvider) ? value : defaultVal;
        }
        ...
        /// <param name="style">Style to use during parsing</param>
        /// <param name="formatProvider">Format provider</param>
        public static ushort ToOrDefault(this string source, ushort defaultVal, NumberStyles style = NumberStyles.Any,
            IFormatProvider formatProvider = null)
        {
            return source.TryTo(out ushort value, style, formatProvider) ? value : defaultVal;
        }
        ...
        /// <param name="style">Style to use during parsing</param>
        /// <param name="formatProvider">Format provider</param>
        public static uint ToOrDefault(this string source, uint defaultVal, NumberStyles style = NumberStyles.Any,
            IFormatProvider formatProvider = null)
        {
            return source.TryTo(out uint value, style, formatProvider) ? value : defaultVal;
        }
        ...
        /// <param name="style">Style to use during parsing</param>
        /// <param name="formatProvider">Format provider</param>
        public static ulong ToOrDefault(this string source, ulong defaultVal, NumberStyles style = NumberStyles.Any,
            IFormatProvider formatProvider = null)
        {
            return source.TryTo(out ulong value, style, formatProvider) ? value : defaultVal;
        }
        ...
        /// <param name="style">Style to use during parsing</param>
        /// <param name="formatProvider">Format provider</param>
        public static float ToOrDefault(this string source, float defaultVal, NumberStyles style = NumberStyles.Any,
            IFormatProvider formatProvider = null)
        {
            return source.TryTo(out float value, style, formatProvider) ? value : defaultVal;
        }
        ...
        /// <param name="style">Style to use during parsing</param>
        /// <param name="formatProvider">Format provider</param>
        public static double ToOrDefault(this string source, double defaultVal, NumberStyles style = NumberStyles.Any,
            IFormatProvider formatProvider = null)
        {
            return source.TryTo(out double value, style, formatProvider) ? value : defaultVal;
        }
        ...
        /// <param name="style">Style to use during parsing</param>
        /// <param name="formatProvider">Format provider</param>
        public static decimal ToOrDefault(this string source, decimal defaultVal, NumberStyles style = NumberStyles.Any,
            IFormatProvider formatProvider = null)
        {
            return source.TryTo(out decimal value, style, formatProvider) ? value : defaultVal;
        }
        ...
        /// <returns>True if parsing is successful else false</returns>
        public static DateTime ToOrDefault(this string source, DateTime defaultVal, string format,
            DateTimeStyles style = DateTimeStyles.AssumeLocal, IFormatProvider formatProvider = null)
        {
            return source.TryTo(out DateTime value, format, style, formatProvider) ? value : defaultVal;
        }
        ...
        /// <param name="style">DateTime style</param>
        /// <returns>True if parsing is successful else false</returns>
        public static DateTime ToOrDefault(this string source, DateTime defaultVal, string[] formats,
            DateTimeStyles style = DateTimeStyles.AssumeLocal, IFormatProvider formatProvider = null)
        {
            return source.TryTo(out DateTime value, formats, style, formatProvider) ? value : defaultVal;
        }
        ...
        /// <param name="style">DateTime style</param>
        /// <returns>True if parsing is successful else false</returns>
        public static DateTime ToOrDefault(this string source, DateTime defaultVal,
            DateTimeStyles style = DateTimeStyles.AssumeLocal, IFormatProvider formatProvider = null)
        {
            return source.TryTo(out DateTime value, style, formatProvider) ? value : defaultVal;
        }
    }
}
